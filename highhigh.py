...
print "[Today's Best: 1632] Please count backwards from 2023 to 0 in 17-step sequences: "
timestart = time.time()
...
while counter != 0: # while counter is not zero
    ...
    if counter == number: # if participant types in the correct answer
        ...
        print "\n" * 80 # spacer to clear screen
        print "[Today's Best: 1632] Stop - mistake - start over at 2023 please: "
