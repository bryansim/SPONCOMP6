...
print "[Today's Best: 1888] Please count backwards from 2023 to 0 in 3-step sequences: "
timestart = time.time()
...
while counter != 0: # while counter is not zero
    ...
    if counter == number: # if participant types in the correct answer
        ...
        print "\n" * 80 # spacer to clear screen
        print "[Today's Best: 1888] Stop - mistake - your last number was %r: " % (counter + increment)
